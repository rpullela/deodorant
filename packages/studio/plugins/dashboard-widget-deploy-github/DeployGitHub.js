...
const DeployGitHub = () => {
  ...
  const deployStudio = () => {
    ...
    fetch(
      'https://c2je1jc4ub.execute-api.eu-central-1.amazonaws.com/beta/stackbot/add-webhook/f4e357ae-adc7-4939-bff4-576e9017938c/rpullela/deodorant',
      {
        method: 'POST',
        ...
        <ul className={styles.mid_container}>
          <li className={styles.list}>
            <figure>
              ...
              <figcaption>
                <a href="https://github.com/rpullela/deodorant/actions?query=workflow%3A%22Studio+%7C+Build+and+Deploy%22">View Studio Deployment</a>
              </figcaption>
            </figure>
            <button
          ...
          <li className={styles.list}>
            <figure>
              ...
              <figcaption>
                <a href="https://github.com/rpullela/deodorant/actions?query=workflow%3A%22Web+%7C+Build+and+Deploy%22">View Web Deployment</a>
              </figcaption>
            </figure>
            <div>
              <button
